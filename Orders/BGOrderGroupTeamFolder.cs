...
namespace Orders
{
    public class BGOrderGroupTeamFolder
    {
        ...
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.NotFound, contentType: "text/plain", bodyType: typeof(string), Description = "The customer group or drive was not found")]
